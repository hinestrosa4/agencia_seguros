<template>
  <div class="contact">
    ...
    <div class="card">
      <div class="card-header">Lista Clientes</div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h5>¿Estás seguro que quieres borrar el cliente <b>{{ selecCliente.id }}</b>?</h5>
            <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-danger" data-bs-dismiss="modal" v-on:click="borrarCliente(selecCliente.id)">
              Borrar
            </button>
          </div>
        </div>
